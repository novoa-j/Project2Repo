...
import { HttpClient } from '@angular/common/http'; // do not use selenium import!
...
export class HealthResultService {
  ...
  token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..ernta5j0nQz_wfwihdSuAJLKn0SAIJcd3QqoTj1HEDs';
  ...
  loadSymptoms(): Observable<Symptom[]> {
    ...
    let finalUrl = 'https://healthservice.priaid.ch/symptoms?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..ernta5j0nQz_wfwihdSuAJLKn0SAIJcd3QqoTj1HEDs&format=json&language=en-gb';
  ...
  loadIssue(id: number): Promise<Issue2> { // takes as input the id, see issue.ts for class + json layout
    let baseUrl = 'https://healthservice.priaid.ch/issues/';
    //let token = this.config.getToken();
    let extraArgs = '&format=json&language=en-gb';
    let finalUrl = baseUrl + id + '/info?token=' + this.token + extraArgs;
    return this.http.get<Issue2>(finalUrl).toPromise();
  }
